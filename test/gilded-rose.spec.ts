...
describe('Gilded Rose', function () {
    ...
    describe('#tick', function () {
        ...
        context ('normal Items', function () {
            ...
            it ('updates normal items close to sell date', function () {
            ...
            it ('updates normal items close to sell date with 0 quality', function () {
                const gildedRose = new GildedRose([ new Item('normal', 0, 1) ]);
            ...
            it ('updates normal items after the sell date and close to minimum quality', function () {
                const gildedRose = new GildedRose([ new Item('normal', 1, -10) ]);
        ...
        context('Backstage Passes', function () {
            /*
                ...
                0 after the concert
             */
            it ('updates Backstage pass items long before the sell date 10 Q - 11 SellIn', function () {
            ...
            it ('updates Backstage pass items close to maximum Quality', function () {

                const gildedRose = new GildedRose([ new Item('Backstage passes to a TAFKAL80ETC concert', 48, 10) ]);
            ...
            it ('updates Backstage pass items even closer to maximum Quality', function () {

                const gildedRose = new GildedRose([ new Item('Backstage passes to a TAFKAL80ETC concert', 49, 10) ]);

                const $item = gildedRose.tick()[0];

                expect($item.quality).to.equal(50); //max quality accepted
                expect($item.sellIn).to.equal(9);
            });
        ...
        context ("Conjured Items", function () {
            ...
            it ('updates Conjured items close to the sell date Quality 20 SellIn 0', function () {
